...
class PlayerField:
		...
		if special_block is not None:
			if special_block.type == "Faster":
				...
				if self.target is not None:
					...
					for x in range(1,9):
						bp = choice(STANDARD_PARTS)(self.dm)
						self.target.lines_to_add.append( (22-x, [(x-1, None), (x, bp), (x+1, None)]) )
				...
				if self.target is not None:
					self.target.field.effects["Inverse"] = BlockPartInverse(self.target.dm, 0, 1)
			elif special_block.type == "Switch":
				self.dm.specialsounds["Switch"].play()
				if self.target is not None:
					self.field.blockparts, self.target.field.blockparts = self.target.field.blockparts, self.field.blockparts
					self.field.blockparts_list, self.target.field.blockparts_list = self.target.field.blockparts_list, self.field.blockparts_list
					self.field.special_block, self.target.field.special_block = self.target.field.special_block, self.field.special_block
					self.rumbles = 0
					self.rumbleblocks = []
				...
				if self.target is not None:
					self.target.field.effects["Mini"] = BlockPartMini(self.target.dm, 1, 1)
			elif special_block.type == "Blink":
				self.dm.specialsounds["Blink"].play()
				if self.target is not None:
					self.target.field.effects["Blink"] = BlockPartBlink(self.target.dm, 2, 1)
			elif special_block.type == "Blind":
				self.dm.specialsounds["Blind"].play()
				if self.target is not None:
					self.target.field.effects["Blind"] = BlockPartBlind(self.target.dm, 3, 1)
			elif special_block.type == "Background":
				self.dm.specialsounds["Background"].play()
				if self.target is not None:
					self.target.field.background_tile = self.target.field.random_background()
				...
				if self.target is not None:
					self.target.field.effects["Trans"] = BlockPartTrans(self.target.dm, 4, 1)	
				...
				if self.target is not None:
					self.target.field.effects["Color"] = BlockPartColor(self.target.dm, 6, 1)
	...
	def castle(self):
		lines = []
		lines.append( (22, [(2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)), 
						(4, BlockPartGrey(self.dm)), (5, BlockPartGrey(self.dm)), 
						(6, BlockPartGrey(self.dm)), (7, BlockPartGrey(self.dm))]) )
						
		lines.append( (21, [(2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)),
						(4, BlockPartGrey(self.dm)),
						(6, BlockPartGrey(self.dm)),(7, BlockPartGrey(self.dm))]) )
		lines.append( (20, [(2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)),
						(4, BlockPartGrey(self.dm)),
						(6, BlockPartGrey(self.dm)),(7, BlockPartGrey(self.dm))]) )
					
		lines.append( (19, [(2, BlockPartGrey(self.dm)),
						(4, BlockPartGrey(self.dm)), (5, BlockPartGrey(self.dm)),
						(6, BlockPartGrey(self.dm)),(7, BlockPartGrey(self.dm))]) )
		lines.append( (18, [(2, BlockPartGrey(self.dm)),
						(4, BlockPartGrey(self.dm)), (5, BlockPartGrey(self.dm)),
						(6, BlockPartGrey(self.dm)),(7, BlockPartGrey(self.dm))]) ) 
						
		lines.append( (17, [(2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)),
						(4, BlockPartGrey(self.dm)), (5, BlockPartGrey(self.dm)),
						(7, BlockPartGrey(self.dm))])	)			
		lines.append( (16, [(2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)),
						(4, BlockPartGrey(self.dm)), (5, BlockPartGrey(self.dm)),
						(7, BlockPartGrey(self.dm))]) )
						
		lines.append( (15, [(2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)),
						(5, BlockPartGrey(self.dm)),
						(6, BlockPartGrey(self.dm)),(7, BlockPartGrey(self.dm))]) )
		lines.append( (14, [(2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)),
						(5, BlockPartGrey(self.dm)),
						(6, BlockPartGrey(self.dm)),(7, BlockPartGrey(self.dm))]) )
		
		lines.append( (13, [(1, BlockPartGrey(self.dm)), (2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)), 
						(4, BlockPartGrey(self.dm)), (5, BlockPartGrey(self.dm)), 
						(6, BlockPartGrey(self.dm)), (7, BlockPartGrey(self.dm)), (8, BlockPartGrey(self.dm))]) )
		lines.append( (12, [(1, BlockPartGrey(self.dm)), (2, BlockPartGrey(self.dm)), (3, BlockPartGrey(self.dm)), 
						(4, BlockPartGrey(self.dm)), (5, BlockPartGrey(self.dm)), 
						(6, BlockPartGrey(self.dm)), (7, BlockPartGrey(self.dm)), (8, BlockPartGrey(self.dm))]) )
		lines.append( (11, [(1, BlockPartGrey(self.dm)), (2, BlockPartGrey(self.dm)), 
						(4, BlockPartGrey(self.dm)), (5, BlockPartGrey(self.dm)), 
						(7, BlockPartGrey(self.dm)), (8, BlockPartGrey(self.dm))]) )
		return lines
	def ring(self):
		lines = []
		lines.append( (22, [(3, None), (4, None), (5, None), (6, None)]) )
		lines.append( (21, [(1, None), (2, None),
		...
		lines.append( (20, [(0, None),
						...
						(9, None)]) )
		lines.append( (19, [(0, None),
						(1, choice(STANDARD_PARTS)(self.dm)), 
						(2, None), (7, None),
						(8, choice(STANDARD_PARTS)(self.dm)),
						(9, None)]) )
		for y in range(18, 14, -1):
			lines.append( (y, [(0, choice(STANDARD_PARTS)(self.dm)), 
							(1, None), (8, None),
							(9, choice(STANDARD_PARTS)(self.dm))]) )
		lines.append( (14, [(0, None),
						(1, choice(STANDARD_PARTS)(self.dm)), 
						(2, None), (7, None),
						(8, choice(STANDARD_PARTS)(self.dm)),
						(9, None)]) )
		lines.append( (13, [(0, None),
						(1, choice(STANDARD_PARTS)(self.dm)), 
						(2, choice(STANDARD_PARTS)(self.dm)),
						(3, None), (4, None), (5, None), (6, None),												
						(7, choice(STANDARD_PARTS)(self.dm)), 
	...
	def next_target(self):
		...
		ok_players = filter(lambda x: not x.gameover, self.dm.players)
	...
	def draw(self):
		...
		glTexCoord2d( 0.96875, 1.0 ); glVertex2d(248.0, 0.0)
		glTexCoord2d( 0.96875, 1-0.78125 ); glVertex2d(248.0, 200.0)
		glTexCoord2d( 0.0, 1-0.78125 ); glVertex2d(0.0, 200.0)
		glEnd()
		...
		if self.packettime > 0:
			...
			for y in range(int(s*4.0+0.99)):
				...
				glBegin(GL_QUADS)
				glTexCoord2d( 7 / 22.0*0.515625, 1.0 ); glVertex2d(-12.0, -12.0)
				glTexCoord2d( 8 / 22.0*0.515625, 1.0 ); glVertex2d(12.0, -12.0)
				glTexCoord2d( 8 / 22.0*0.515625, 0.25 ); glVertex2d(12.0, 12.0)
				glTexCoord2d( 7 / 22.0*0.515625, 0.25 ); glVertex2d(-12.0, 12.0)
				glEnd()
		...
		for x in range(self.antidotes):
			...
			glBegin(GL_QUADS)
			glTexCoord2d( 13 / 22.0*0.515625, 1.0 ); glVertex2d(-12.0, 0.0)
			glTexCoord2d( 14 / 22.0*0.515625, 1.0 ); glVertex2d(12.0, 0.0)
			glTexCoord2d( 14 / 22.0*0.515625, 0.25 ); glVertex2d(12.0, 24*1.0)
			glTexCoord2d( 13 / 22.0*0.515625, 0.25 ); glVertex2d(-12.0, 24*1.0)
			glEnd()
		self.field.draw()
		glColor(1, 1, 1)
