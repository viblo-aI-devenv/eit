...
class BlockField:
	def __init__(self, dm, px, py):
		...
		### Special Effects
		self.effects = {"Inverse":None, "Mini":None, "Blink":None, "Blind":None,
					"Trans":None, "SZ":None, "Color":None} 
		self.blink = 0
	...
	def random_background(self):
		background = choice(self.dm.backgrounds.values())
		return background
	...
	def draw(self):
		...
		glTexCoord2d( 1.0, 1.0 ); glVertex2d(248.0, 0.0)
		glTexCoord2d( 1.0, 0.0 ); glVertex2d(248.0, 536.0)
		glTexCoord2d( 0.0, 0.0 ); glVertex2d(0.0, 536.0)
		glEnd()
		...
		glBegin(GL_QUADS)
		glTexCoord2d( 0.0, 4.125 ); glVertex2d(0.0, 0.0)
		glTexCoord2d( 1.875, 4.125 ); glVertex2d(240.0, 0.0)
		glTexCoord2d( 1.875, 0.0 ); glVertex2d(240.0, 528.0)
		glTexCoord2d( 0.0, 0.0 ); glVertex2d(0.0, 528.0)
		glEnd()
		...
		if self.effects["Color"] is not None:
			...
			if self.currentblock is not None:
				...
				pass
			glBegin(GL_QUADS)
			glTexCoord2d( 0.0 -dx, 0.0 -dy); glVertex2d(0.0, 0.0)
			glTexCoord2d( 0.5 -dx, 0.0 -dy); glVertex2d(240.0, 0.0)
			glTexCoord2d( 0.5 -dx, 0.5 -dy); glVertex2d(240.0, 528.0)
			glTexCoord2d( 0.0 -dx, 0.5 -dy); glVertex2d(0.0, 528.0)
			glEnd()
		...
		for k, sbp in self.effects.iteritems():
			if sbp is not None:
				sbp.draw()
		self.check()
	...
	def check(self):
		for bp in self.blockparts_list:
			try:
				if self.blockparts[bp.y][bp.x].x != bp.x or self.blockparts[bp.y][bp.x].y != bp.y:
